...
## PROJECT STATUS: PROOF OF CONCEPT, NOT MAINTAINED (2026-07-27)

**Arcana UI is dormant.** It was a proof of concept for a machine-readable, token-driven design system that AI agents can compose. The concept shipped (108 components, 14 presets, four npm packages at 0.1.x, manifest/llms.txt/MCP/DESIGN.md integrations), and active development has ended. No new features, fixes, or releases are planned.

Meta has since released [Astryx](https://astryx.atmeta.com/), an open-source machine-readable design system (React + StyleX, 160+ components, agent-ready docs and CLI) that pursues a very similar concept with a full-time team behind it.

**For AI agents working in this repo:** treat every task as historical maintenance on an archived codebase. Do not start roadmap work (the phases below are kept as a record, not a plan). The Session Protocol, branch rules, and code standards below still apply to any change Bear explicitly requests.
...
### Active Phase
**None. Project sunset 2026-07-27.** Arcana was a proof of concept and is no longer being maintained or built. See the status section at the top of this file. Final state: `@arcana-ui/core@0.1.2`, `@arcana-ui/tokens@0.1.0`, `@arcana-ui/cli@0.1.0`, `@arcana-ui/mcp@0.1.0`, and `@arcana-ui/claude-design-pack@0.1.0` all published on npm; 108 components, 14 presets, 990 passing tests; playground, 6 demos, and docs scaffold deployed.

At sunset, `develop` was 7 commits ahead of `main` (#125-#128 plus the back-merge; no release was cut after v0.1.2), and PRs #129 (tracker refresh) and #130 (docs MDX generation) were open. Those two PRs predate the sunset decision: merge or close them at Bear's discretion; the roadmap work they served is discontinued.

Meta's [Astryx](https://astryx.atmeta.com/) (React + StyleX, 160+ components, agent-ready docs and CLI) now occupies this concept space with active maintenance.
...
| Phase P — Playground Product | 🔄 Partial | P.1-P.5, P.5.1, P.9, P.13 done; P.5.2/.3, P.6-P.12 deferred; P.14 (Claude Design pack) new |
| Phase 5 — AI Integration & Launch | 🔄 Partial | 5.1-5.4, 5.9, 5.11 done; 5.5 scaffolded; 5.12 (DESIGN.md export) new |

### Key Milestones Reached
- **v0.1.1 published** on npm. `@arcana-ui/core@0.1.1` carries the CSS-module class-name map fix; tokens, cli, mcp remain at 0.1.0.
...
- P.14 — **NEW.** `@arcana-ui/claude-design-pack` of 14 DESIGN.md files + landing page at `arcana-ui.com/claude-design`. Targets the `claude.ai/design/#org → Add assets` flow. Driven by Claude Design launch 2026-04-17. See `~/Documents/Claude/Projects/Arcana/COMPETITIVE_INTEL_2026-05-07.md`.
...
- 5.12 — **NEW.** DESIGN.md export validating against `@google/design.md` CLI in CI. Driven by Google Labs spec release 2026-04-21.
...
### Blockers
None. The project is sunset; there is nothing pending.

### What the Next Agent Should Do
1. Read the PROJECT STATUS section at the top of this file first.
2. Do not start roadmap work. Phases P, 5, 6, 7, and 8 are discontinued.
3. Only act on explicit requests from Bear (e.g. archival housekeeping, a security fix to a published package, taking sites offline). Follow the normal branch/PR/changelog rules for any such change.

### Session History

| Date | Agent | Tasks Completed | Notes |
|------|-------|-----------------|-------|
| 2026-07-27 | Claude (Claude Code) | Project sunset notice | Bear declared Arcana a proof of concept that is no longer being maintained or built. Added the PROJECT STATUS section at the top of this file, the README status callout, PROGRESS.md sunset header, and a CHANGELOG entry (branch `docs/poc-sunset-notice-astryx`). Context: Meta released [Astryx](https://astryx.atmeta.com/), an open-source machine-readable design system (React + StyleX, 160+ components, agent-ready docs and CLI) pursuing a very similar concept. Final published state: core 0.1.2; tokens, cli, mcp, claude-design-pack 0.1.0 (pack published 2026-05-11). At sunset, `develop` was 7 ahead of `main` and PRs #129 (tracker refresh) and #130 (docs MDX generation, 5.5) were open; both predate the sunset decision and are Bear's call to merge or close. Historical note for readers of this table: rows below describe active development that has since ended. |
